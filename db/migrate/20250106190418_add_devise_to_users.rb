...
class AddDeviseToUsers < ActiveRecord::Migration[7.2]
  def self.up
    change_table :users, bulk: true do |t|
      ...
      ## Trackable (opcional, descomentado si lo necesitas más adelante)
      ...
      ## Confirmable (opcional, descomentado si lo necesitas más adelante)
      ...
      ## Lockable (opcional, descomentado si lo necesitas más adelante)
  ...
  def self.down
    # Al ser irreversible, dejamos como estaba originalmente
